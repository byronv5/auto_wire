...
- [Altium schematic file format](#altium-schematic-file-format)
  ...
  - [Object records](#object-records)
    ...
    - [Image](#image)
    - [Sheet](#sheet)
    - [Sheet name and file name](#sheet-name-and-file-name)
    - [Designator](#designator)
    - [Bus entry](#bus-entry)
    - [Template](#template)
    - [Parameter](#parameter)
    - [Warning sign](#warning-sign)
    - [Implementation list](#implementation-list)
